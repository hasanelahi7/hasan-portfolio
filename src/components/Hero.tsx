      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row items-center justify-between gap-12">
          <div className="flex-1 text-center md:text-left">
            ...
            <div className="text-xl md:text-2xl text-gray-600 dark:text-gray-400 mb-6 h-8">
              I'm a{' '}
            ...
            <p className="text-lg text-gray-600 dark:text-gray-400 mb-8 max-w-2xl">
              Full-stack developer with expertise in UI/UX design and machine learning.
              I specialize in building modern web applications with React, TypeScript, and Tailwind CSS.
            </p>
            <div className="flex flex-wrap gap-4 justify-center md:justify-start">
              ...
              <a
                href="#contact"
                className="px-6 py-3 border-2 border-primary-600 text-primary-600 dark:text-primary-400 rounded-lg hover:bg-primary-50 dark:hover:bg-gray-800 transition-colors"
              >
                Get in Touch
              </a>
              <a
